...
Terraform language, they are valid in the `type` argument of an
[input variable](/terraform/language/block/variable),
[module output](/terraform/language/block/output),
or [`convert`](/language/functions/convert) function call.
