...
values will be stored in the raw state as plain text: `key_id`, `b64_mac_key`, `b64url_mac_key`, `mac_key`.
...
* `b64_mac_key` -
  ...
  **Note**: This property is sensitive and will not be displayed in the plan.
  ...
  ~> **Warning:** `b64_mac_key` is deprecated and will be removed in a future major release. Use `mac_key` instead.
...
* `b64url_mac_key` -
  ...
  **Note**: This property is sensitive and will not be displayed in the plan.
  ...
  ~> **Warning:** `b64url_mac_key` is deprecated and will be removed in a future major release. Use `mac_key` instead.
