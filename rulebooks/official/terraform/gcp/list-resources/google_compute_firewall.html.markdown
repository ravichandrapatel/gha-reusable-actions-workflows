...
# google_compute_firewall (list)

Lists [`google_compute_firewall`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/google_compute_firewall) resources for use with [`terraform query`](https://developer.hashicorp.com/terraform/cli/commands/query) and **`.tfquery.hcl`** files.
...
```hcl
list "google_compute_firewall" "all" {
  provider = google
