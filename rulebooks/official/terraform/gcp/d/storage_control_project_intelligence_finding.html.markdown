...
```hcl
data "google_storage_control_project_intelligence_finding" "finding" {
...
* `id` - an identifier for the resource with format `projects/{{project}}/locations/{{location}}/intelligenceFindings/{{finding_id}}`
