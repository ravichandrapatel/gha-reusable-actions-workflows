...
* This deprecated resource has been superseded by `azurerm_cognitive_account` and has been removed from the Azure Provider. See the [migration guide](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/ai_services#migration-to-azurerm_cognitive_account) for attribute mapping.
