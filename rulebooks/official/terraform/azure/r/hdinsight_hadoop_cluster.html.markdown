...
* `name` - (Required) The name of the install script action.

* `uri` - (Required) The URI pointing to the script to run during the installation of the edge node.
...
* `name` - (Required) The name of the uninstall script action.
