...
* `node_version` - (Optional) The version of Node to use. Possible values are `~12`, `~14`, `~16`, `~18`, `~20`, `~22` and `~24`.

* `powershell_core_version` - (Optional) The PowerShell Core version to use. Possible values are `7`, `7.2`, `7.4`, and `7.6`.
