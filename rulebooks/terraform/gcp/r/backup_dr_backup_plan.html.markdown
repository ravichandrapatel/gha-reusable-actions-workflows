...
* `disk_backup_plan_properties` -
  ...
  Structure is [documented below](#nested_disk_backup_plan_properties).
...
* `compute_instance_backup_plan_properties` -
  ...
  Structure is [documented below](#nested_compute_instance_backup_plan_properties).
...
<a name="nested_disk_backup_plan_properties"></a>The `disk_backup_plan_properties` block supports:
...
<a name="nested_compute_instance_backup_plan_properties"></a>The `compute_instance_backup_plan_properties` block supports:
