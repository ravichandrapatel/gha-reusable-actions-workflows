...
~> **NOTE:** This resource manages Security Hub CSPM, which is distinct from the unified Security Hub V2 service managed by `aws_securityhub_account_v2`. Both can coexist in the same account.
