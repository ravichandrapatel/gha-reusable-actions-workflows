...
Follow root [`AGENTS.md`](../../../AGENTS.md). When revising design/specs after new facts, ground with `python3 _okf_knowledge/kernel/okf.py pack --budget 1200 "<keywords>"` or `lookup --card --limit 2` as needed. Plan-time: OKF standards win — auto-correct design and note deviations in `proposal.md`. Keep `[MUTATION GATE]` tasks coherent with high-risk steps. Never edit application code in this skill.
